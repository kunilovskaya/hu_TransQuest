...
from examples.wmt_2020.en_zh.transformer_plus_config import TEMP_DIRECTORY, MODEL_TYPE, MODEL_NAME, \
...
# format_submission(df=test, index=index, language_pair="ro-en", method="hu_TransQuest",
