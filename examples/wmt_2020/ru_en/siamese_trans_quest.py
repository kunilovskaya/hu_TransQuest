...
from examples.wmt_2020.ru_en.siamese_transformer_config import TEMP_DIRECTORY, GOOGLE_DRIVE, DRIVE_FILE_ID, MODEL_NAME, \
...
format_submission(df=test, index=index, language_pair="ru-en", method="SiameseTransQuest",
