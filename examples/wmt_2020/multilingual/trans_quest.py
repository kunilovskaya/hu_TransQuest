...
from examples.wmt_2020.multilingual.transformer_config import TEMP_DIRECTORY, GOOGLE_DRIVE, DRIVE_FILE_ID, MODEL_NAME, \
...
for dev, test, index, language in zip(dev_list, test_list, index_list, [*languages]):
    ...
    if language == "RU-EN":
        format_submission(df=test, index=index, language_pair=language.lower(), method="hu_TransQuest",
