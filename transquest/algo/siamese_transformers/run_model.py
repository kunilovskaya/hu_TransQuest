...
class SiameseTransQuestModel(nn.Sequential):
    ...
    def fit(self,
            ...
            optimizer_class: Type[Optimizer] = my_transformers.AdamW,
    ...
    def evaluate(self, evaluator: SentenceEvaluator, output_path: str = None, result_path: str = None,
        ...
        :param result_path:
            the evaluator can write the predictions to this path
        :param verbose:
            print the results
        :param evaluator:
            the evaluator
        ...
        if output_path is not None:
            os.makedirs(output_path, exist_ok=True)
        return evaluator(self, output_path, result_path, verbose)
    ...
    def _get_scheduler(self, optimizer, scheduler: str, warmup_steps: int, t_total: int):
        ...
        if scheduler == 'constantlr':
            return my_transformers.get_constant_schedule(optimizer)
        elif scheduler == 'warmupconstant':
            return my_transformers.get_constant_schedule_with_warmup(optimizer, num_warmup_steps=warmup_steps)
        elif scheduler == 'warmuplinear':
            return my_transformers.get_linear_schedule_with_warmup(optimizer, num_warmup_steps=warmup_steps,
                                                                   num_training_steps=t_total)
        elif scheduler == 'warmupcosine':
            return my_transformers.get_cosine_schedule_with_warmup(optimizer, num_warmup_steps=warmup_steps,
                                                                   num_training_steps=t_total)
        elif scheduler == 'warmupcosinewithhardrestarts':
            return my_transformers.get_cosine_with_hard_restarts_schedule_with_warmup(optimizer,
